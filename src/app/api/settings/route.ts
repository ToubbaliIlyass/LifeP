...
export interface Settings {
  ...
  /**
   * How the app handles tasks that are due but have no time.
   * - off:     nothing happens
   * - suggest: it proposes times each morning for the user to approve
   * - auto:    it places them directly, no approval
   */
