  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="text-[clamp(16px,5.4vw,48px)] text-muted-foreground/50 overflow-hidden whitespace-nowrap"
          style={{
        ...
        {/* "Act" — serif */}
        <span className="text-[clamp(16px,5.4vw,48px)] font-serif font-semibold text-foreground tracking-tight">
          Act
        </span>
