...
export function HabitNode({ data }: NodeProps) {
  ...
  return (
    <div className="flex flex-col items-center select-none" style={{ width: 104 }}>
      ...
      <div className="w-[46px] h-[46px] rounded-full bg-emerald-300/80 dark:bg-emerald-400/50 border border-emerald-300/50"
        style={{ boxShadow: '0 0 6px oklch(0.74 0.17 163 / 18%)' }} />
