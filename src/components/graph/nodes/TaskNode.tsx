...
export function TaskNode({ data }: NodeProps) {
  ...
  return (
    <div className="flex flex-col items-center select-none" style={{ width: 104 }}>
      ...
      <div className={`w-[46px] h-[46px] rounded-full border ${done ? 'bg-muted/40 border-border/30' : 'bg-sky-300/80 dark:bg-sky-400/50 border-sky-300/50'}`}
        style={done ? {} : { boxShadow: '0 0 6px oklch(0.74 0.16 232 / 18%)' }} />
