...
export function TaskNode({ data }: NodeProps) {
  ...
  const done = d.properties.status === 'done'
  return (
    <div className="flex flex-col items-center select-none" style={{ width: 90 }}>
      ...
      <div className={`w-[38px] h-[38px] rounded-full border ${done ? 'bg-muted/40 border-border/30' : 'bg-sky-500/70 dark:bg-sky-400/60 border-sky-300/40'}`}
        style={done ? {} : { boxShadow: '0 0 10px oklch(0.74 0.16 232 / 35%)' }} />
